...
export default function BurgerShowcase({ burger, activeIndex, isReady, isActive, isInteractive, onTraySwipe, onBurgerTap }) {
  return (
    <section id="tray" className={`showcase${isReady ? ' is-ready' : ''}${isActive ? ' is-active' : ''}`} aria-label="Burger menüsü">
      <div className="showcase-panel">
        ...
        <TrayTouchZone enabled={isInteractive} onSwipe={onTraySwipe} onTap={onBurgerTap} />
