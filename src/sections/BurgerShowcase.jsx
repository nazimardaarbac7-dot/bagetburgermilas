  ...
  return (
    <section id="tray" className={`showcase${isReady ? ' is-ready' : ''}${isActive ? ' is-active' : ''}`} aria-label="Burger menüsü">
      <div className="showcase-panel">
        ...
        <p className="rotate-prompt"><i /><span className="rotate-copy-desktop">SCROLL TO ROTATE THE TRAY</span><span className="rotate-copy-mobile">KAYDIR / TEPSİYİ SÜRÜKLE</span></p>
